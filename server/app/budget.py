...
- 절차: 
   ...
   3. ★핵심 연산 규칙★: 이 모드는 총 가용 금액의 절반이상을 의도적으로 어떤 카테고리에도 배정하지 않고 '미할당 여유 자금'으로 남겨두는 모드입니다. 하지만 상황에 따라 경우 ‘미할당 여유 자금’을 늘리거나 줄여도 됨
"""
    elif mode == "relaxed":
        return """
[예산 성향: 균형 모드]
...
- 절차: 
  ...
  3. ★핵심 연산 규칙★: 이 모드는 총 가용 30%이상을 비상금 및 추가 저축용 '미할당 여유 자금'으로 남겨두는 모드입니다. 하지만 상황에 따라 경우 ‘미할당 여유 자금’을 늘리거나 줄여도 됨
"""
    else:
        return """
[예산 성향: 여유 모드]
...
- 절차:
  ...
  3. ★핵심 연산 규칙★: 이 모드는 소비 만족도를 극대화하는 모드로, 10%이상을 '미할당 여유 자금'으로 남겨둡니다. 하지만 상황에 따라 경우 ‘미할당 여유 자금’을 늘리거나 줄여도 됨
"""
